...
namespace NCCWebsite002.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var users = db.users.Include(u => u.enrollment);
        ...
        {
            ViewBag.userid = new SelectList(db.enrollments, "userid", "admnno");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "userid,username,password,role")] user user)
        {
            ...
            ViewBag.userid = new SelectList(db.enrollments, "userid", "admnno", user.userid);
            return View(user);
        }
